# ================================================
# TEST — Xception + LSTM | Masked Face Senaryosu
...
MODEL_PATH = '/content/drive/MyDrive/FaceForensics_Data/xception_lstm_masked.keras'
...
DATA_PATH  = '/content/drive/MyDrive/FaceForensics_Data/Xception_Frames_Masked_299'
SAVE_PATH  = '/content/drive/MyDrive/FaceForensics_Data/Grafikler_Xception_LSTM_Masked'
...
for n_frame in frame_sayilari:
    print(f"\n{'='*50}")
    print(f"  Kare sayısı: {n_frame} — Xception+LSTM Masked Face")
    print(f"{'='*50}")
...
plt.title('Karmaşıklık Matrisi — Xception+LSTM Masked Face (10 Kare)', fontsize=12)
...
plt.title('ROC Eğrisi — Xception+LSTM Masked Face (10 Kare)', fontsize=12)
plt.legend(loc='lower right'); plt.grid(True, alpha=0.3)
plt.tight_layout()
plt.savefig(f'{SAVE_PATH}/roc_curve_video.png', dpi=150); plt.show()

print(f"\n{'='*65}")
print(f"ÖZET — Xception+LSTM Masked Face Video Bazlı")
print(f"{'='*65}")

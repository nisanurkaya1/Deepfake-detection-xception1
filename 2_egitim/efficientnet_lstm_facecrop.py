# ================================================
# EĞİTİM — EfficientNetB0 + LSTM | Face Crop Senaryosu
...
print("\n🚀 EfficientNetB0+LSTM Face Crop eğitim başlıyor...")
history = model.fit(
    train_ds,
...
plt.title('Epoch vs. Kayıp — EfficientNetB0+LSTM Face Crop', fontsize=14)
...
plt.title('Epoch vs. Doğruluk — EfficientNetB0+LSTM Face Crop', fontsize=14)

# ================================================
# EĞİTİM — EfficientNetB0 + LSTM | Full Frame Senaryosu
...
MODEL_PATH = '/content/drive/MyDrive/FaceForensics_Data/efficientnet_lstm_fullframe.keras'
SAVE_PATH  = '/content/drive/MyDrive/FaceForensics_Data/Grafikler_EfficientNet_LSTM_FullFrame'
...
print("\n🚀 EfficientNetB0+LSTM Full Frame eğitim başlıyor...")
history = model.fit(
    train_ds,
...
plt.title('Epoch vs. Kayıp — EfficientNetB0+LSTM Full Frame', fontsize=14)
...
plt.title('Epoch vs. Doğruluk — EfficientNetB0+LSTM Full Frame', fontsize=14)

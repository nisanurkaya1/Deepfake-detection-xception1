# ================================================
# EĞİTİM — Xception + LSTM | Face Crop Senaryosu
...
print("\n🚀 Xception+LSTM Face Crop eğitim başlıyor...")
history = model.fit(
    train_ds,
...
plt.title('Epoch vs. Kayıp — Xception+LSTM Face Crop', fontsize=14)
...
plt.title('Epoch vs. Doğruluk — Xception+LSTM Face Crop', fontsize=14)

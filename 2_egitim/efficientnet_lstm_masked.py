# ================================================
# EĞİTİM — EfficientNetB0 + LSTM | Masked Face Senaryosu
...
DATA_PATH  = '/content/drive/MyDrive/FaceForensics_Data/Xception_Frames_Masked'
MODEL_PATH = '/content/drive/MyDrive/FaceForensics_Data/efficientnet_lstm_masked.keras'
SAVE_PATH  = '/content/drive/MyDrive/FaceForensics_Data/Grafikler_EfficientNet_LSTM_Masked'
...
print("\n🚀 EfficientNetB0+LSTM Masked Face eğitim başlıyor...")
history = model.fit(
    train_ds,
...
plt.title('Epoch vs. Kayıp — EfficientNetB0+LSTM Masked Face', fontsize=14)
...
plt.title('Epoch vs. Doğruluk — EfficientNetB0+LSTM Masked Face', fontsize=14)

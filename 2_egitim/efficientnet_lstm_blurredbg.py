# ================================================
# EĞİTİM — EfficientNetB0 + LSTM | Blurred Background Senaryosu
# FaceForensics++ DeepFakes + Face2Face (c23)
# Video bazlı bölme, seed=42
# Real: 20 kare, Fake: 10 kare → 1:1 oran
# ================================================
...
DATA_PATH  = '/content/drive/MyDrive/FaceForensics_Data/EfficientNet_Frames_BlurredBG'
MODEL_PATH = '/content/drive/MyDrive/FaceForensics_Data/efficientnet_lstm_blurredbg.keras'
SAVE_PATH  = '/content/drive/MyDrive/FaceForensics_Data/Grafikler_EfficientNet_LSTM_BlurredBG'
...
print("\n🚀 EfficientNetB0+LSTM Blurred Background eğitim başlıyor...")
history = model.fit(
    train_ds,
...
plt.title('Epoch vs. Kayıp — EfficientNetB0+LSTM Blurred Background', fontsize=14)
...
plt.title('Epoch vs. Doğruluk — EfficientNetB0+LSTM Blurred Background', fontsize=14)
